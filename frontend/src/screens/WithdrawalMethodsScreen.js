      ...
      <ScrollView className="flex-1 px-6 pt-8">
        ...
        <View className="mt-10 bg-blue-50 p-6 rounded-3xl border border-blue-100">
          ...
          <Text className="text-blue-600/70 text-xs leading-5">
            Your earnings are held securely until you request a withdrawal. Once you reach the minimum balance of {user?.role === 'restaurant_owner' ? 'Rs. 1000.00' : 'Rs. 20.00'}, you can transfer your funds to any of the methods saved above.
          </Text>
        </View>
      </ScrollView>
