    ...
    <View className="flex-1 bg-white">
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <View className="px-6 pt-8 pb-32">
          <View className="flex-row justify-between items-start">
            ...
            <Text className="text-3xl font-bold text-primary" numberOfLines={1} adjustsFontSizeToFit>Rs.{"\u200B"} {currentItem.price ?? '0'}</Text>
          </View>
                  ...
                  >
                    <View className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm">
                      ...
                      <View className="p-3">
                        ...
                        <Text className="text-primary font-bold text-xs mt-1" numberOfLines={1} adjustsFontSizeToFit>Rs.{"\u200B"} {rec.price ?? '0'}</Text>
                      </View>
                    </View>
                  </TouchableOpacity>
                ))}
      ...
      <View className="absolute bottom-10 left-6 right-6">
        ...
        >
          ...
          <Text className="text-white font-bold text-lg" numberOfLines={1} adjustsFontSizeToFit>Rs.{"\u200B"} {((currentItem.price || 0) * quantity).toFixed(2)}</Text>
        </TouchableOpacity>
      </View>
